...
Всё это называется вслух при сборке таблицы: `BlobchegPatchTableBuilder.Diagnostics` уходит в
`Debug.LogError` на старте процесса. Один неправильно объявленный компонент не выключает патч всему
проекту — он просто не регистрируется.
