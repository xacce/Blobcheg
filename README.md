...
**форкнутый** `com.unity.entities`: в него добавлена точка расширения `BlobchegPatchHook` и три её
вызова. Сама логика патча в форк не переехала — там только вызовы.
