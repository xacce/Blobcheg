...
8. [Хеш имени: адрес, переживающий пересборку](#хеш-имени-адрес-переживающий-пересборку)
9. [BlobchegReference: указатель вместо оффсета](#blobchegreference-указатель-вместо-оффсета)
10. [Пересборка](#пересборка)
11. [Проверки и ошибки](#проверки-и-ошибки)
12. [Справочник API](#справочник-api)
13. [Сборки пакета](#сборки-пакета)
14. [Разработка пакета](#разработка-пакета)
